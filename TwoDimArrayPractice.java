...
* Fills the array with random numbers between 50 and 80 The instance variable

* named intArray is the integer array to be filled with values
...
* Prints array to the console, elements are separated by a space The instance

* variable named intArray is the integer array to be printed
...
* Sets all the elements in the specified row to the specified value The

* instance variable named intArray is the integer array

*

* @param value

* the value to assign to the element of the row

* @param row

* the row in which to set the elements to value
...
System.out.println("........Set Value...... for row " + row + " with value= " + value);
...
* Finds minimum value in the specified column The instance variable named

* intArray is the integer array
...
System.out.println("... Find Minimum from Column =" + column);

int minValue = Integer.MAX_VALUE;// start with some max value

for (int i = 0; i < intArray.length; i++) {

if (minValue > intArray[i][column]) {

minValue = intArray[i][column];// change the min value to the current value

}

animate(i, column, minValue); // animate the output

}

System.out.println("Minimum of in column " + column + " = " + minValue);
...
* Finds the number of times value is found in the array The instance variable

* named intArray is the integer array
...
System.out.println(".....Count Frequency of value= " + value + " in the matrix.");

int count = 0; // local variable to store count of the value.
...
count++; // if value is found increment the counter.
...
System.out.println("Number of times value = " + value + " occured is = " + count);
